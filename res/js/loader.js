document.write('<link href="/boot/css/bootstrap.min.css" rel="stylesheet"> \
        ...
        <link href="/boot/css/bootstrap-datetimepicker.min.css" rel="stylesheet"> \
        <link href="/boot/css/bootstrapValidator.css" rel="stylesheet">\
        <link href="/boot/css/bootstrapValidator.min.css" rel="stylesheet">\
        <link href="/boot/css/style.css" rel="stylesheet"> \
        <link href="/boot/css/demo.css" rel="stylesheet"> \
        <link href="/boot/css/zTreeStyle.css" rel="stylesheet"> \
        <script src="/boot/js/modernizr.js"></script> \
 \
        <script src="/boot/js/jquery.min.js"></script> \
        <script src="/boot/js/jquery.md5.js"></script> \
        <script src="/boot/js/md5.js"></script> \
...
\
        ...
        <script src="/boot/js/bootstrap-datetimepicker.min.js"></script> \
        <script src="/boot/js/bootstrap-datetimepicker.zh-CN.js"></script> \
        <script src="/boot/js/bootstrapValidator.js"></script> \
        <script src="/boot/js/bootstrapValidator.min.js"></script> \
 \
	   ...
	   <script src="/boot/js/Chart.js"></script>\
        ...
        <script src="/boot/js/jquery.ztree.core.min.js"></script> \
        <script src="/boot/js/jquery.ztree.excheck.min.js"></script> \
        <script src="/boot/js/jquery.ztree.exedit.min.js"></script> \
        <script src="/boot/js/jquery.ztree.exhide.min.js"></script> \
        <script src="/boot/extends.js"></script>  \
        <script src="/pipes/dync/js/mydata"></script>');
/**
 * \
        <script src="/pipes/network/nwagency/js/tops"></script>\
        <script src="/pipes/network/nwsupplier/js/list"></script>\
        <script src="/pipes/network/nwpackage/js/list"></script>
 */