$(document).ready(function () {
    $.strtodate = function (strTime) {
        if (!strTime) return 0;
        var dateStrs = strTime.split("-");
    ...
    //-------------------------- status ----------------------------------------------------------
    $.defStatusRender = function (value, type, full) {
    ...
    window.defStatusRender = $.defStatusRender;
    //-------------------------- topbar ----------------------------------------------------------
    var topbarhtml = [];
    topbarhtml.push('<div class="topbar-left"><div class="text-center"><a href="" class="logo">红柚子管理平台</a></div></div>');
    ...
    menuhtml.push('    <li class="first_active"><a href=""><i class="fa fa-home"></i>  <span>工作台首页</span></a></li>');
